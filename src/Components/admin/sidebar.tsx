...
function Sidebar() {
	...
	const sidecollapse = sidebarContext.togglesidebar

	return (
		<section id={'sidebar'} className={sidecollapse ? 'hide' : ''}>
				<a href="#" className="brand"><i className='bx bxs-smile icon'></i> AdminSite</a>
				<ul className="side-menu">
					...
					<li>
						<a href="#"><i className='bx bxs-inbox icon' ></i> Elements <i className='bx bx-chevron-right icon-right' ></i></a>
